...
const ShareComponent = () => {
  ...
  const [sourcePlace, setSourcePlace] = useState('Uptron');
  const [destinationPlace, setDestinationPlace] = useState("Uptron");
    ...
    <div className="bg-gray-100 pt-3 pb-3">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {allPaths.length > 0 && <Map myPoints={myPoints} allPaths={allPaths} />}
          </div>
        </div>
      </div>
      <RideSharedPopup
